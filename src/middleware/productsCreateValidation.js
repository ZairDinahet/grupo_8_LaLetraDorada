...
const productsCreateValidation = [
  ...
  body('biography').notEmpty().withMessage("Debe completar completar la biografia del autor").bail().escape(),
...
module.exports = productsCreateValidation